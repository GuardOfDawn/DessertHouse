...
@Controller
public class StoreSellingAction extends BaseAction{
	...
	private JFreeChart formChart(){
		...
		String[][] storeSellingDis = saleperformanceManage.getStoreSellingDis(DayTransformer.transformToMonth(date));
		...
		JFreeChart barChart = ChartFactory.createBarChart("店铺销售分布图", "店铺名称", 
                "销售额", data, PlotOrientation.VERTICAL, true, true, false);
